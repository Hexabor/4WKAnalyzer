...
const CHANGELOG=[
  {
    ...
    items:[
      ...
      {type:'new', text:'Editar un preset — botón ✎ junto al × en cada pill: aplica el preset, abre el inspector en modo edición (cabecera «Editando «Nombre»», botón «Guardar cambios») y al guardar manteniendo el mismo nombre sobrescribe directo sin pedir confirmación; cambiar el nombre crea una variante nueva'},
    ]
  },
  {
  ...
  },
  {
    ...
    items:[
      ...
      {type:'fix', text:'Volver a un modo por defecto («4 últimas consolidadas» o «Incl. semana actual») desde un preset de tiendas restablece el filtro a todas las tiendas; los presets personalizados, restauración de backup y navegación entre ventanas siguen respetando el filtro guardado'},
    ]
  },
  {
